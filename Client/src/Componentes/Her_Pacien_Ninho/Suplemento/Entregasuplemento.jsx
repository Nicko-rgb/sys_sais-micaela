...
function Entregasuplemento() {
  ...
  const handleEntrega = (suplemento, cantidad, presentacion) => {
    if (
      ...
      setModalMessage("Por favor complete el campo cantidad.");
      setShowModal(true);
      return;
    }
      ...
      <div className={style.entregacontainer}>
        {paciente ? (
          <>
            ...
            <button
                className={style.histosupplementbutton}
                onClick={() =>
                  navigate(`/Listasuplemento/${paciente.hist_clinico}`, {
                    state: { paciente },
                  })
            ...
            <div className={style.cardscontainer}>
              ...
              <div className={style.card}>
                ...
                <div className={style.alert}>
                  Puede entregar estos suplementos!
                </div>
                <form className={style.form}>
                  <div className={style.formRow}>
                    <label>
                      N° Entrega: <input type="number" value="1" readOnly />
                    </label>
                    <label>
                      Fec. Atención:
                      <input
                  ...
                  <button
                    ...
                    onClick={() => {
                      const cantidad =
                        document.getElementById("cantidadVA").value;
                      const presentacion =
                        document.getElementById("presentacionVA").value;
              ...
              <div className={style.card}>
                ...
                <form className={style.form}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      const cantidad =
                        document.getElementById("cantidadZN").value;
                      const presentacion =
                        document.getElementById("presentacionZN").value;
              ...
              <div className={style.card}>
                ...
                <form className={style.form}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      const cantidad =
                        document.getElementById("cantidadMZ").value;
                      const presentacion =
                        document.getElementById("presentacionMZ").value;
              ...
              <div className={style.card}>
                ...
                <form className={style.form}>
                  ...
                  <button
                    ...
                    onClick={() => {
                      const cantidad =
                        document.getElementById("cantidadMN").value;
                      const presentacion =
                        document.getElementById("presentacionMN").value;
                      handleEntrega(
                        "Suplemento 24m-35m",
                        cantidad,
                        presentacion
            ...
            <div className={style.info}>
              ...
              <p>
                Cantidad: Número de insumos entregados (Cajas, Jarabes, Blister,
                Capsulas)
              </p>
              <p>
                Presentación: MN (Micronutrientes - Chispitas), SF (Sulfato
                Ferroso), HP (Hierro Polimaltozado), MZ (Mebendazol), VA
                (Vitamina A)
              </p>
            </div>
          </>
